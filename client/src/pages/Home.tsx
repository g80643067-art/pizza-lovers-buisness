...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      ...
      <main>
        <section className="hero hero--slice-opening" id="home"><div className="container hero-grid"><div className="hero-copy"><div className="hero-proof"><span className="eyebrow"><i /> Veg-only pizza at Takiya Mela Ground</span><span className="hero-veg-seal"><i /> 100% Veg only</span></div><h1 className="display hero-title">One good slice.<br /><em>That&apos;s the point.</em></h1><p className="hero-kicker"><b>Fresh from the oven, made to share.</b><br />Start with the slice that catches your eye, then make the rest of your order at your own pace.</p><div className="hero-actions"><a className="button-primary" href="#menu">See the menu <ArrowUpRight size={15} /></a><button type="button" className="button-quiet" onClick={openCart}>Your order <ShoppingBag size={15} /></button></div><div className="hero-meta"><div className="hero-status"><b>Open until 10 PM</b>₹1–200 per person</div></div></div><div className="hero-stage"><Suspense fallback={null}><PizzaScene /></Suspense></div></div><a className="scroll-cue" href="#menu"><span aria-hidden="true" /> Scroll for the menu</a></section>
